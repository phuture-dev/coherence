...
class FilesTest extends TestCase
{
    ...
    public function testFindFiles(): void
    {
        ...
        $results = Files::findFiles($this->tempDir, '*.txt');
    ...
    public function testFindFilesDefaultMask(): void
    {
        ...
        $results = Files::findFiles($this->tempDir);
    ...
    public function testFindFilesNoMatch(): void
    {
        ...
        $results = Files::findFiles($this->tempDir, '*.php');
    ...
    public function testFindFilesRecursive(): void
    {
        ...
        $results = Files::findFiles($this->tempDir, '*.txt', recursive: true);
    ...
    public function testFindFilesWithMultipleMasks(): void
    {
        ...
        $results = Files::findFiles($this->tempDir, ['*.txt', '*.php']);
