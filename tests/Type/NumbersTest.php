...
class NumbersTest extends TestCase
{
    ...
    {
        Assert::same(Numbers::mean([1, 2, 3, 4, 5]), FluentNumbers::from(0)->mean([1, 2, 3, 4, 5]));
        Assert::same(Numbers::mean([1.5, 2.5, 3.5]), FluentNumbers::from(0)->mean([1.5, 2.5, 3.5]));
    }

    public function testMeanEmptyArrayThrows(): void
    {
        Assert::exception(
            fn () => FluentNumbers::from(0)->mean([]),
            \InvalidArgumentException::class
        );
    }
    ...
    {
        Assert::same(Numbers::median([1, 3, 5]), FluentNumbers::from(0)->median([1, 3, 5]));
        Assert::same(Numbers::median([1, 3, 5, 7]), FluentNumbers::from(0)->median([1, 3, 5, 7]));
    }

    public function testMedianEmptyArrayThrows(): void
    {
        Assert::exception(
            fn () => FluentNumbers::from(0)->median([]),
            \InvalidArgumentException::class
        );
    }
    ...
    {
        Assert::same(Numbers::mode([1, 2, 2, 3, 3, 3]), FluentNumbers::from(0)->mode([1, 2, 2, 3, 3, 3]));
        Assert::same(Numbers::mode([1, 1, 2, 2, 3]), FluentNumbers::from(0)->mode([1, 1, 2, 2, 3]));
    }

    public function testModeEmptyArrayThrows(): void
    {
        Assert::exception(
            fn () => FluentNumbers::from(0)->mode([]),
            \InvalidArgumentException::class
        );
    }
    ...
    public function testVariance(): void
    {
        ...
        Assert::same(Numbers::variance($values), FluentNumbers::from(0)->variance($values));
    }

    public function testVarianceEmptyArrayThrows(): void
    {
        Assert::exception(
            fn () => FluentNumbers::from(0)->variance([]),
            \InvalidArgumentException::class
        );
    }
    ...
    {
        $values = [2, 4, 4, 4, 5, 5, 7, 9];
        Assert::same(Numbers::sampleVariance($values), FluentNumbers::from(0)->sampleVariance($values));
    }

    public function testSampleVarianceSingleValueThrows(): void
    {
        Assert::exception(
            fn () => FluentNumbers::from(0)->sampleVariance([5]),
            \InvalidArgumentException::class
        );
    }
    ...
    public function testStandardDeviation(): void
    {
        $values = [2, 4, 4, 4, 5, 5, 7, 9];
        Assert::same(
            Numbers::standardDeviation($values),
            FluentNumbers::from(0)->standardDeviation($values)
        );
    }
    ...
    public function testSampleStandardDeviation(): void
    {
        $values = [2, 4, 4, 4, 5, 5, 7, 9];
        Assert::same(
            Numbers::sampleStandardDeviation($values),
            FluentNumbers::from(0)->sampleStandardDeviation($values)
        );
    }
    ...
    public function testPercentile(): void
    {
        Assert::same(
            ...
            FluentNumbers::from(0)->percentile([1, 2, 3, 4, 5], 50)
        );
        Assert::same(
            Numbers::percentile([1, 2, 3, 4, 5], 0),
            FluentNumbers::from(0)->percentile([1, 2, 3, 4, 5], 0)
        );
        Assert::same(
            Numbers::percentile([1, 2, 3, 4, 5], 100),
            FluentNumbers::from(0)->percentile([1, 2, 3, 4, 5], 100)
        );
    }

    public function testPercentileOutOfRangeThrows(): void
    {
        Assert::exception(
            fn () => FluentNumbers::from(0)->percentile([1, 2, 3], 101),
            \InvalidArgumentException::class
        );
    }

    public function testStatisticalRange(): void
    {
        Assert::same(Numbers::range([3, 7, 2, 9, 5]), FluentNumbers::from(0)->range([3, 7, 2, 9, 5]));
        Assert::same(Numbers::range([1.5, 4.5]), FluentNumbers::from(0)->range([1.5, 4.5]));
    }

    public function testStatisticalRangeEmptyArrayThrows(): void
    {
        Assert::exception(
            fn () => FluentNumbers::from(0)->range([]),
            \InvalidArgumentException::class
        );
    }
}
