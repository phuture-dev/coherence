...
class StringsTest extends TestCase
{
    ...
    {
        Assert::same(
            Strings::replaceArray('Year: ?, Month: ?', '?', ['2026', 'April']),
    ...
    public function testPad(): void
    {
        ...
        Assert::same(Strings::pad('hello', 10, '-'), FluentStrings::from('hello')->pad(10, '-')->get());
        Assert::same(Strings::pad('hello', 10, ' ', PadDirection::Left), FluentStrings::from('hello')->pad(10, ' ', PadDirection::Left)->get());
        Assert::same(Strings::pad('hello', 10, '-', PadDirection::Both), FluentStrings::from('hello')->pad(10, '-', PadDirection::Both)->get());
        Assert::same(Strings::pad('hello', 11, '-', PadDirection::Both), FluentStrings::from('hello')->pad(11, '-', PadDirection::Both)->get());
        Assert::same(Strings::pad('5', 5, '0', PadDirection::Left), FluentStrings::from('5')->pad(5, '0', PadDirection::Left)->get());
    }
