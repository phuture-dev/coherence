...
class NumbersTest extends TestCase
{
    ...
    {
        Assert::same('120.0000000000', Numbers::addPercentage(100, 20));
        Assert::same('55.0000000000', Numbers::addPercentage(50, 10));
        Assert::same('210.0000000000', Numbers::addPercentage(200, 5));
        Assert::same('0.0000000000', Numbers::addPercentage(0, 50));
        Assert::same('100.0000000000', Numbers::addPercentage(100, 0));
    }

    public function testAddPercentageWithDecimals(): void
    {
        Assert::same('115.0000000000', Numbers::addPercentage(100, 15));
        Assert::same('110.0000000000', Numbers::addPercentage(100, 10));
        Assert::same('105.5000000000', Numbers::addPercentage(100, 5.5));
    }

    public function testAddPercentageWithNegativeNumber(): void
    {
        Assert::same('-120.0000000000', Numbers::addPercentage(-100, 20));
    }
    ...
    {
        $numbers = [3.0, 1.0, 2.0];
        usort($numbers, [Numbers::class, 'compare']);
        Assert::same([1.0, 2.0, 3.0], $numbers);
    }
    ...
    {
        Assert::same('40.0000000000', Numbers::percentage(200, 20));
        Assert::same('5.0000000000', Numbers::percentage(50, 10));
        Assert::same('5.0000000000', Numbers::percentage(100, 5));
        Assert::same('0.0000000000', Numbers::percentage(0, 50));
        Assert::same('0.0000000000', Numbers::percentage(100, 0));
        Assert::same('5.5000000000', Numbers::percentage(100, 5.5));
    }
    ...
    {
        Assert::same('80.0000000000', Numbers::subtractPercentage(100, 20));
        Assert::same('45.0000000000', Numbers::subtractPercentage(50, 10));
        Assert::same('190.0000000000', Numbers::subtractPercentage(200, 5));
        Assert::same('0.0000000000', Numbers::subtractPercentage(0, 50));
        Assert::same('100.0000000000', Numbers::subtractPercentage(100, 0));
    }

    public function testSubtractPercentageWithDecimals(): void
    {
        Assert::same('85.0000000000', Numbers::subtractPercentage(100, 15));
        Assert::same('90.0000000000', Numbers::subtractPercentage(100, 10));
        Assert::same('94.5000000000', Numbers::subtractPercentage(100, 5.5));
    }

    public function testSubtractPercentageWithNegativeNumber(): void
    {
        Assert::same('-80.0000000000', Numbers::subtractPercentage(-100, 20));
    }
