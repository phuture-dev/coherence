...
class Files extends StaticClass
{
     ...
     * @param string $destination The path where the archive file will be saved
     * @param \Phuture\Coherence\Enum\CompressionFormat $format The archive format to use (default: Zip)
     * @throws \Phuture\Coherence\Exception\InvalidArgumentException If the source path does not exist
    ...
    public static function compress(
        ...
        if (!file_exists($source)) {
            throw new InvalidArgumentException(
                "Invalid Argument: Source path {$source} does not exist"
            );
        }
