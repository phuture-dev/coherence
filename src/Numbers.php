...
class Numbers extends StaticClass
{
     ...
     * ```
     *
     * @param int|float|string $left The first addend
     * @param int|float|string $right The second addend
    ...
    {
        return bcadd((string) $left, (string) $right, self::DEFAULT_SCALE);
    }
     ...
     * ```
     *
     * @param int|float|string $number The base number
     * @param int|float|string $percentage The percentage to add (e.g. 20 means 20%)
     * @return string The increased value as a BCMath string
     * @see \Phuture\Coherence\Numbers::subtractPercentage()
    ...
    {
        $amount = bcdiv(
            bcmul((string) $number, (string) $percentage, self::DEFAULT_SCALE),
            '100',
            self::DEFAULT_SCALE
        );

        return bcadd((string) $number, $amount, self::DEFAULT_SCALE);
    }
     ...
     * ```
     *
     * @param int|float|string $left The first value to compare
     * @param int|float|string $right The second value to compare
    ...
    {
        self::assertNotNan($left, 'left');
        self::assertNotNan($right, 'right');

        return bccomp((string) $left, (string) $right, self::DEFAULT_SCALE) === 0;
    }
    ...
    public static function compare(int|float|string $left, int|float|string $right): int
    {
        ...
        return bccomp((string) $left, (string) $right, self::DEFAULT_SCALE);
    }
     ...
     * @param int|float|string $divisor The divisor (must not be zero)
     ...
     * ```
     *
     * @param int|float|string $left The value to test
     * @param int|float|string $right The value to compare against
     * @return bool True when $left is strictly greater than $right
     * @throws \Phuture\Coherence\Exception\LogicException When either value is NAN
     ...
     * @param int|float|string $left The value to test
     * @param int|float|string $right The value to compare against
     * @return bool True when $left is greater than or equal to $right
     * @throws \Phuture\Coherence\Exception\LogicException When either value is NAN
     ...
     * @param int|float|string $left The value to test
     * @param int|float|string $right The value to compare against
     * @return bool True when $left is strictly less than $right
     * @throws \Phuture\Coherence\Exception\LogicException When either value is NAN
     * @see \Phuture\Coherence\Numbers::isLessThanOrEqualTo()
     * @see \Phuture\Coherence\Numbers::isGreaterThan()
     */
     ...
     * @param int|float|string $left The value to test
     * @param int|float|string $right The value to compare against
     * @return bool True when $left is less than or equal to $right
     * @throws \Phuture\Coherence\Exception\LogicException When either value is NAN
     * @see \Phuture\Coherence\Numbers::isLessThan()
     * @see \Phuture\Coherence\Numbers::isGreaterThanOrEqualTo()
     */
     ...
     * ```
     *
     * @param int|float|string $first The first number
     * @param int|float|string $second The second number
    ...
    {
        return bccomp((string) $first, (string) $second, self::DEFAULT_SCALE) >= 0 ? $first : $second;
    }
    ...
    public static function modulus(int|float|string $dividend, int|float|string $divisor): string
    {
        ...
        return bcmod((string) $dividend, (string) $divisor, self::DEFAULT_SCALE);
    }
     ...
     * ```
     *
     * @param int|float|string $left The first factor
     * @param int|float|string $right The second factor
    ...
    {
        return bcmul((string) $left, (string) $right, self::DEFAULT_SCALE);
    }
     ...
     *
     * @param int|float|string $number The base number
     * @param int|float|string $percentage The percentage to calculate (e.g. 20 means 20%)
     * @return string The percentage amount as a BCMath string
     * @see \Phuture\Coherence\Numbers::addPercentage()
     * @see \Phuture\Coherence\Numbers::subtractPercentage()
     */
     ...
     * ```
     *
     * @param int|float|string $left The minuend
     * @param int|float|string $right The subtrahend
    ...
    {
        return bcsub((string) $left, (string) $right, self::DEFAULT_SCALE);
    }
     ...
     *
     * @param int|float|string $number The base number
     * @param int|float|string $percentage The percentage to subtract (e.g. 20 means 20%)
     * @return string The decreased value as a BCMath string
     * @see \Phuture\Coherence\Numbers::addPercentage()
     * @see \Phuture\Coherence\Numbers::percentage()
     * @see \Phuture\Coherence\Numbers::subtract()
     */
    public static function subtractPercentage(int|float|string $number, int|float|string $percentage): string
    {
        ...
        return bcsub((string) $number, $amount, self::DEFAULT_SCALE);
    }
